        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("cannot connect book".concat(error_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("Could not find book ".concat(id, " . Error:").concat(error_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    booksStore.prototype.create = function (B) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'INSERT INTO books (title,author,total_pages ,type)VALUES($1, $2, $3, $4) RETURNING *';
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new Error("Could not add new book ".concat(B.title, ". Error: ").concat(error_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
